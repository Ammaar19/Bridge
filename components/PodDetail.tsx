          ...
          <div className="py-4">
            ...
            <div className="flex-1">
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <h1 className="text-3xl text-gray-900">{pod.name}</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        {pod.description && (
          <Card className="p-4 mb-6">
            <h2 className="text-lg text-gray-900 mb-3 flex items-center space-x-2">
        ...
        <Card className="p-4 mb-6">
          <div className="flex justify-between items-center mb-3">
            <h2 className="text-lg text-gray-900">Workflow Progress</h2>
        ...
        {/* Team Members */}
        <Card className="p-4">
          <h2 className="text-lg text-gray-900 mb-4">Team Members &amp; Tasks</h2>
