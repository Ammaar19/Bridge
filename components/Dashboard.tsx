        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div>
              ...
              <p className="text-muted-foreground mt-1">Project Handoff Management</p>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="space-y-4">
          <div className="flex justify-between items-center">
            <h2 className="text-xl text-gray-900">Active PODs</h2>
          </div>

          {activePods.length === 0 ? (
            <Card className="p-8 text-center">
              <Users className="h-10 w-10 text-muted-foreground mx-auto mb-3" />
              <h3 className="text-lg mb-2">No Active PODs</h3>
          ...
          {completedPods.length > 0 && (
            <>
              <div className="flex justify-between items-center mt-8">
                <h2 className="text-xl text-gray-900">Completed PODs</h2>
              </div>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
    ...
    <Card className="p-4 hover:shadow-lg transition-shadow cursor-pointer relative" onClick={handleCardClick}>
      ...
      <div className="flex justify-between items-start mb-3 pr-8">
        <div className="flex-1">
          <h3 className="text-lg text-gray-900 mb-1">{pod.name}</h3>
